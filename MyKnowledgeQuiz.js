...
const questions = [
  ...
  {
    question: "Kabuki ဆိုတဲ့ ဂျပန်ရိုးရာ ပြဇာတ်မှာ မင်းသမီးအခန်းကဏ္ဍတွေကို ဘယ်သူတွေ သရုပ်ဆောင်သလဲ? ",
    options: ["အမျိုးသမီးတွေ ", "အမျိုးသားတွေ", "ကလေးတွေ ", "Robotတွေ"],
    image:"img/kabuki.webp",
    correctAnswer: "အမျိုးသားတွေ"
  },
   {
  ...
  },
  {
    ...
    options: ["နွေဦးရဲ့နွေးထွေးတဲ့ ရာသီဥတုကို နှစ်သက်လို့", "အလှဆုံးအချိန်ဖြစ်လို့", "လူတွေက နွေဦးရာသီကို ကြိုက်ကြလို့  ", "တခြားပန်းတွေ မပွင့်လို့"],
  ...
  {
    question: "ဂျပန်ရဲ့ အကျော်ကြားဆုံး ဗုဒ္ဓဘုရားရုပ်တု Great Buddha က ဘယ်မြို့မှာရှိသလဲ?",
    options: ["နာရာ", "ကာမာကူရာ", "ကျိုတို", "တိုကျို"],
    image:"img/kamakura.jfif",
    correctAnswer: "ကာမာကူရာ"
  },
  {
